...
def lambda_handler(event, context):
    ...
    quote_currency_price_increment = abs(round(math.log(float(productInfo['quote_increment']),10)))
    base_currency_price_increment = abs(round(math.log(float(productInfo['base_increment']),10)))
    #--------------------------------------

    #Your Limit Price 
    my_limit_price = str(round(float(productInfo['price']) * factor,quote_currency_price_increment))
